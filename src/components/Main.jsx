        ...
        <main className="main">
            <div className="top__banner">
                <div className="banner__inner">
                    ...
                    <button onClick={changeModal} className="order__btn">Заказать услугу</button>
                </div>
            </div>
            ...
            <OrderPopUp isOverlay={isOverlay} isModal={isModal} changeModal={changeModal}/>
        </main>
